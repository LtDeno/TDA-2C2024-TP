...
with open(f"ap_posibles_cotas_empiricas.txt", "w") as archivo_resultados:
    for archivo in casos_de_prueba:
        ...
        res_AP = parte3.elegir_algoritmo_demanda_cumplida(parte3.obtener_datos(archivo), "AP")
        archivo_resultados.write(f"I={archivo}, z(I)= {res_OPT}, A(I) = {res_AP}, A(I)/z(I) = {(res_AP/res_OPT)}\n")
